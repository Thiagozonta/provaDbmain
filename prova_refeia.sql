...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13-Jun-2025 às 13:49
...
CREATE TABLE `agencias` (
  ...
  `numeroAgencia` bigint(14) DEFAULT NULL
...
CREATE TABLE `cartao` (
  ...
  `cvc` bigint(20) DEFAULT NULL,
  `validade` date DEFAULT NULL,
  `tipo` varchar(45) DEFAULT NULL,
  `codSeguranca` bigint(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `cartao` (`idCartao`, `nome`, `banda`, `cvc`, `validade`, `tipo`, `codSeguranca`) VALUES
(1, 'jose oliveira', 'sicredi', 323, '2005-07-18', 'credito', 8825),
(2, 'pedro alves', 'mastercard', 455, '2020-05-20', 'credito', 7121),
(3, 'maria eduarda conte', 'itau', 922, '2007-08-09', 'debito', 1077),
(4, 'cristina luz', 'inter', 337, '2017-11-06', 'debito', 9999),
(5, 'pedro joel', 'mastercard', 855, '2022-05-20', 'credito', 2883),
(6, 'thiago talis', 'itau', 222, '2009-08-09', 'debito', 9432),
(7, 'gabriela santos', 'inter', 727, '2018-11-06', 'debito', 7664),
(8, 'jose oliveira', 'sicredi', 323, '2005-07-18', 'credito', 8825),
(9, 'pedro alves', 'mastercard', 455, '2020-05-20', 'credito', 7121),
(10, 'maria eduarda conte', 'itau', 922, '2007-08-09', 'debito', 1077),
(11, 'cristina luz', 'inter', 337, '2017-11-06', 'debito', 9999),
(12, 'pedro joel', 'mastercard', 855, '2022-05-20', 'credito', 2883),
(13, 'thiago talis', 'itau', 222, '2009-08-09', 'debito', 9432),
(14, 'gabriela santos', 'inter', 727, '2018-11-06', 'debito', 7664),
(15, 'jose oliveira', 'sicredi', 323, '2005-07-18', 'credito', 8825),
(16, 'pedro alves', 'mastercard', 455, '2020-05-20', 'credito', 7121),
(17, 'maria eduarda conte', 'itau', 922, '2007-08-09', 'debito', 1077),
(18, 'cristina luz', 'inter', 337, '2017-11-06', 'debito', 9999),
(19, 'pedro joel', 'mastercard', 855, '2022-05-20', 'credito', 2883),
(20, 'thiago talis', 'itau', 222, '2009-08-09', 'debito', 9432),
(21, 'gabriela santos', 'inter', 727, '2018-11-06', 'debito', 7664);
...
INSERT INTO `clientes` (`ID`, `NOME`, `SOBRENOME`, `EMAIL`, `GENERO`, `EMPRESA`) VALUES
...
CREATE TABLE `movimento` (
  ...
  `email` varchar(45) DEFAULT NULL,
  `endereco` varchar(45) DEFAULT NULL,
  `horaMovimentacao` datetime DEFAULT NULL,
  `idSaque` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `transacoes` (
  ...
  `tipoTransacao` varchar(45) DEFAULT NULL,
...
ALTER TABLE `movimento`
  ADD PRIMARY KEY (`idConta`),
  ADD KEY `idTransacoes` (`idTransacoes`);
...
--
ALTER TABLE `cartao`
  MODIFY `idCartao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `financeiro`
  MODIFY `cpf` bigint(14) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `agencias`
  ADD CONSTRAINT `agencias_ibfk_1` FOREIGN KEY (`idCliente`) REFERENCES `clientes` (`ID`);

--
-- Limitadores para a tabela `conta`
--
ALTER TABLE `conta`
  ADD CONSTRAINT `conta_ibfk_1` FOREIGN KEY (`idClientes`) REFERENCES `clientes` (`ID`);

--
-- Limitadores para a tabela `emprestimos`
--
ALTER TABLE `emprestimos`
  ADD CONSTRAINT `emprestimos_ibfk_1` FOREIGN KEY (`idCliente`) REFERENCES `clientes` (`ID`);

--
-- Limitadores para a tabela `financeiro`
--
ALTER TABLE `financeiro`
  ADD CONSTRAINT `financeiro_ibfk_1` FOREIGN KEY (`idAgencia`) REFERENCES `agencias` (`idAgencia`);

--
-- Limitadores para a tabela `funcionarios`
--
ALTER TABLE `funcionarios`
  ADD CONSTRAINT `funcionarios_ibfk_1` FOREIGN KEY (`idAgencia`) REFERENCES `agencias` (`idAgencia`);

--
-- Limitadores para a tabela `movimento`
--
ALTER TABLE `movimento`
  ADD CONSTRAINT `movimento_ibfk_1` FOREIGN KEY (`idTransacoes`) REFERENCES `transacoes` (`idTransacao`);
...
ALTER TABLE `pedidos`
  ...
  ADD CONSTRAINT `pedidos_ibfk_2` FOREIGN KEY (`idCartao`) REFERENCES `cartao` (`idCartao`);

--
-- Limitadores para a tabela `transacoes`
--
ALTER TABLE `transacoes`
  ADD CONSTRAINT `transacoes_ibfk_1` FOREIGN KEY (`idConta`) REFERENCES `conta` (`idConta`);
COMMIT;
