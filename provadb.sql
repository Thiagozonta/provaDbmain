...
(3, 'maria eduarda conte', 'itau', 922, '2007-08-09', 'debito', 107),
(4, 'cristina luz', 'inter', 337, '2017-11-06', 'debito', 9994),
(5, 'pedro joel', 'mastercard', 855, '2022-05-20', 'credito', 7541),
(6, 'thiago talis', 'itau', 222, '2009-08-09', 'debito', 7),
...
INSERT INTO `clientes` (`id`, `NOME`, `SOBRENOME`, `EMAIL`, `SEXO`, `NomeEmpresa`) VALUES
...
--
ALTER TABLE `cartao`
  MODIFY `idCartao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `pedido_ibfk_1` FOREIGN KEY (`idClientes`) REFERENCES `clientes` (`id`),
  ADD CONSTRAINT `pedido_ibfk_2` FOREIGN KEY (`idCartao`) REFERENCES `cartao` (`idCartao`);
COMMIT;
